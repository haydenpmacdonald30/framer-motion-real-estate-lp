(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var useMotionContext = function (parentContext, controls, visualElement, isStatic, _a) {
        ...
        var layoutDeltas = React.useRef(__spreadArrays((parentContext.layoutDeltas || []), [
            layoutDelta,
        ]));
    ...
    var SharedLayoutContextProvider = function (props) {
        ...
        var sharedLayoutContext = React.useContext(SharedLayoutContext);
        var autoValues = React.useContext(MotionPluginContext).autoValues;
        return (React.createElement(Auto
    ...
    function useDrag(props, visualElement, controls) {
        ...
        React.useEffect(function () { return dragControls.mount(visualElement.getInstance()); }, []);
    }
    ...
    var PresenceChild = function (_a) {
        ...
        return (React.createElement(PresenceContext.Provider, { value: __assign(__assign({ id: id }, context), { register: register }) }, children));
    };
