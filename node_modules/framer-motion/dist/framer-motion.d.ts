 ...
 * @public
 */
export declare class AnimateSharedLayout extends React.Component<SharedLayoutProps, SharedLayoutTree> {
    /**
...
declare class Auto extends React.Component<FeatureProps & ContextProps> {
    /**
     * If this is a child of AnimateSharedLayout, this callback must be used to unregister on unmount
     */
    private unregisterSharedLayoutContext?;
    /**
    ...
    shouldComponentUpdate(nextProps: FeatureProps & ContextProps): boolean;
    /**
    ...
    hide(): void;
    show(): void;
    setVisibility(visibilityAction: VisibilityAction): void;
    /**
     * Start an auto or shared layout animation.
     */
    startAnimation({ origin, target, visibilityAction, ...opts }?: AutoAnimationConfig): void | Promise<void>;
    /**
     ...
     */
    startLayoutAnimation(opts: AutoAnimationConfig): Promise<void> | undefined;
    /**
     * This is a straight animation between prev/next styles. This animates
     * styles that don't need scale inversion correction.
     */
    startStyleAnimation(opts: AutoAnimationConfig): Promise<void> | undefined;
    updateBoundingBox(p: number, origin?: number): void;
    updateTransform(x: MotionValue<number>, y: MotionValue<number>, scaleX: MotionValue<number>, scaleY: MotionValue<number>): void;
    updateRotate(p: number, rotate: MotionValue<number>): void;
    isPresent(): boolean;
    safeToRemove(): void;
    render(): null;
}

declare interface AutoAnimateProps {
    /**
     * @public
     */
    layoutId?: string;
 ...
 */
declare interface AutoAnimationConfig {
    origin?: Snapshot;
    target?: Snapshot;
    visibilityAction?: VisibilityAction;
    transition?: Transition;
    crossfadeEasing?: Easing_2;
 ...
 * @public
 */
export declare interface AutoValueHandler {
    read?: Read | false;
 ...
 * @public
 */
export declare type AutoValueHandlers = {
...
declare type FlushMagicChildren = (handler?: TransitionHandler) => void;
...
declare class HTMLVisualElement<E extends HTMLElement | SVGElement = HTMLElement> extends VisualElement<E> {
    ...
    protected config: DOMVisualElementConfig;
    /**
...
declare class LayoutStack<T extends StackChild = StackChild> {
    order: T[];
    lead?: T | undefined;
    follow?: T | undefined;
    ...
    shouldStackAnimate(): boolean | undefined;
    getFollowOrigin(): Snapshot | undefined;
    getFollowTarget(): Snapshot | undefined;
    getLeadOrigin(): Snapshot | undefined;
    getLeadTarget(): Snapshot | undefined;
}
 ...
 * @public
 */
export declare interface MotionProps extends AnimationProps, MotionCallbacks, GestureHandlers, DraggableProps, AutoAnimateProps, MotionAdvancedProps {
    /**
...
declare type Read = (computedStyle: string) => string | number;
...
declare interface SharedBatchTree {
    add: (child: Auto) => void;
 ...
 * @internal
 */
export declare const SharedLayoutContext: import("react").Context<SharedBatchTree | SharedLayoutTree>;

declare interface SharedLayoutProps {
    /**
     * @public
     */
 ...
 */
declare interface SharedLayoutTree {
    forceRender: () => void;
    register: (child: Auto) => () => void;
    move: (child: Auto) => void;
}
...
declare interface TransitionHandler {
...
declare type Updater = (p: number) => void;
...
declare class VisualElementDragControls {
    ...
    recordBoxInfo(constraints?: AxisBox2D | false): void;
